...
<div class="admin-wrap">
    ...
    <aside class="sidebar">
        ...
        <a href="{{ route('admin.manual-sales.index') }}" class="nav-item {{ request()->routeIs('admin.manual-sales.*') ? 'active' : '' }}">🧾 Penjualan Manual</a>
        <a href="{{ route('admin.products.index') }}" class="nav-item {{ request()->routeIs('admin.products.*') ? 'active' : '' }}">👟 Kelola Produk</a>
        <a href="{{ route('admin.stock-ins.index') }}" class="nav-item {{ request()->routeIs('admin.stock-ins.*') ? 'active' : '' }}">📦 Stok Masuk &amp; HPP</a>
        <a href="{{ route('admin.reports.index') }}" class="nav-item {{ request()->routeIs('admin.reports.*') ? 'active' : '' }}">📈 Laporan Keuangan</a>

        <div class="sb-section">Data Master</div>
        <a href="{{ route('admin.categories.index') }}" class="nav-item {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}">🏷️ Kategori</a>
        <a href="{{ route('admin.suppliers.index') }}" class="nav-item {{ request()->routeIs('admin.suppliers.*') ? 'active' : '' }}">🚚 Supplier</a>

        <div class="sb-section">Sistem</div>
        <a href="{{ route('admin.configuration.edit') }}" class="nav-item {{ request()->routeIs('admin.configuration.*') ? 'active' : '' }}">⚙️ Konfigurasi</a>
    ...
    <div class="admin-main">
        <div class="topbar">
            ...
            <div class="right">
                @yield('page-actions')
                <a href="{{ route('home') }}" target="_blank" class="btn btn-ghost btn-sm">Lihat Toko ↗</a>
            </div>
        </div>
